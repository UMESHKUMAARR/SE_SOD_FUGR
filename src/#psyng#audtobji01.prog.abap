*----------------------------------------------------------------------*
* INCLUDE PROGRAM       : /PSYNG/AUDTOBJI01
...
MODULE clear_start INPUT.
  CLEAR: g_start_pos, g_start_onode, g_start_tnode, g_start_swaudid.
...
MODULE f1_help_auditid INPUT.
  ...
  CALL FUNCTION '/PSYNG/BASIS_F1_HELP'
       EXPORTING
            dokname = '/PSYNG/SECUWELL_SWAUDID'.

ENDMODULE.                 " F1_HELP_AUDITID  INPUT
