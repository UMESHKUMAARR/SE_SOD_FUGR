...
*----------------------------------------------------------------------*
FUNCTION /psyng/sw_api_i_sod_by_role.
*"----------------------------------------------------------------------
*"*"Local Interface:
*"  IMPORTING
...
*"----------------------------------------------------------------------
  ...
  DATA : lt_return     TYPE TABLE OF  bapiret2 WITH HEADER LINE,
         ...
         lt_agr_1251   type table of agr_1251, "not used in this api
...
*--Get logging configuration
    se_config_param 'APILOG_SOD_BY_ROLE' l_logging.
    IF l_logging = 'Y'.
