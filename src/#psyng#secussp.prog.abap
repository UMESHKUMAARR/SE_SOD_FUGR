...
MODULE INIT0312 OUTPUT.
  ...
  SELECT * FROM /PSYNG/TEXTS WHERE TEXTNAME = 'SSP'.
...
* EOC by RGUPTA On 28.03.22 for C0700
  CASE OK_CODE.
    WHEN 'SAVE'.
      ...
      DELETE FROM /PSYNG/TEXTS WHERE TEXTNAME = 'SSP'.
      LOOP AT I_TEXT.
        IF SY-TABIX > 0.
          /PSYNG/TEXTS-TEXTNAME = 'SSP'.
