FUNCTION-POOL /PSYNG/SW_SOD_OBJS4.          "MESSAGE-ID ..
INCLUDE /PSYNG/SW_CONFIG.
TABLES: agr_agrs, tstct, /psyng/functtran, /psyng/conflict,
        /psyng/confdet, /psyng/faobj2, adr6, usr21, /psyng/mcusrgrp,
         usr02, agr_define, rfcdes, varid,
        agr_1016, agr_1251, agr_1252, ust10s, ust12.
