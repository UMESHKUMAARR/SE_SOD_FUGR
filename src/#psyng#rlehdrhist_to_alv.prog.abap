...
CREATE_TIM FROM
  ...
  W_FIELDCAT-SELTEXT_L = 'Function ID'(000).
  ...
  W_FIELDCAT-TABNAME   = 'LT_HIST'.
  W_FIELDCAT-SELTEXT_L = 'Status'(001).
  ...
  W_FIELDCAT-TABNAME   = 'LT_HIST'.
  W_FIELDCAT-SELTEXT_L = 'Create User'(002).
  W_FIELDCAT-COL_POS = 3.
  APPEND W_FIELDCAT TO V_ALV_FIELDCAT.
  CLEAR W_FIELDCAT.

  W_FIELDCAT-FIELDNAME = 'CREATE_DAT'.
  W_FIELDCAT-SELTEXT_L = 'Create Date'(003).
  W_FIELDCAT-TABNAME   = 'LT_HIST'.
  ...
  W_FIELDCAT-SELTEXT_L = 'Create Time'(004).
  W_FIELDCAT-TABNAME   = 'LT_HIST'.
  ...
  W_FIELDCAT-SELTEXT_L = 'Field Name'(005).
  ...
  W_FIELDCAT-SELTEXT_L = 'Old Value'(006).
  W_FIELDCAT-TABNAME   = 'LT_TRAN_T'.
  ...
  W_FIELDCAT-SELTEXT_L = 'New Value'(007).
  W_FIELDCAT-TABNAME   = 'LT_TRAN_T'.
